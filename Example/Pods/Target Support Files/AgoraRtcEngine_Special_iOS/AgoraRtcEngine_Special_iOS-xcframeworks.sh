...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_Special_iOS/AgoraDrmLoaderExtension.xcframework" "AgoraRtcEngine_Special_iOS" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
